...
# ringankan tampilan (biar tidak berat)
df_view = df.copy()
...
st.caption(f"Menampilkan {len(df)} data terbaru")
...
def generate_pdf(dataframe):
    ...
    elements.append(Paragraph(f"Operan Shift - {selected_unit}", styles['Title']))
