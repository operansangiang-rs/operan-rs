...
st.sidebar.markdown("### 🏥 Unit")
selected_unit = st.sidebar.radio("", unit_list)
...
with st.container(border=True):
    ...
    edit_text = st.text_area("Isi Operan Baru", height=120)

    if st.button("💾 Update Operan", use_container_width=True):
